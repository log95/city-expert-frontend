...
<script>
    ...
    import qs from 'qs';
    import ListItem from '@/components/Moderation/Test/ListItem';
    import TestPublishStatus from "../../../enum/TestPublishStatus";

    export default {
        name: 'ModerationTestIndex',
        components: {
            ListItem,
        },
        data: function () {
        ...
        methods: {
            ...mapActions({
                loadModerationTests: 'moderationTests/loadList',
                loadCities: 'cities/loadList',
            }),
            async loadTests() {
                this.isLoadingItems = true;

                await this.loadModerationTests({
                    params: {
                        page: this.page,
